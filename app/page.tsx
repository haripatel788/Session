    ...
    <main className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-200px)]">
      <div>
        ...
        <div className="mt-10 flex gap-4 justify-center">
          ...
          <a
            href="/signup"
            className="rounded-xl border border-gray-300 dark:border-white/20 bg-white dark:bg-transparent px-6 py-3 text-sm font-semibold text-black dark:text-white hover:bg-gray-100 dark:hover:bg-white/5 transition"
          >
            Sign up
          </a>
        </div>
